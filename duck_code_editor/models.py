...
class Trial(models.Model):
    ...
    percpetion_q1 = models.CharField(max_length=50, null=True, default=None)
    percpetion_q2 = models.CharField(max_length=50, null=True, default=None)
    percpetion_q3 = models.CharField(max_length=50, null=True, default=None)
    percpetion_q4 = models.CharField(max_length=50, null=True, default=None)
    percpetion_q5 = models.CharField(max_length=50, null=True, default=None)
    percpetion_q6 = models.CharField(max_length=50, null=True, default=None)
    percpetion_q7 = models.CharField(max_length=50, null=True, default=None)
